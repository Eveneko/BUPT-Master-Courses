...
\begin{frame}
    ...
    \begin{parchment}[Research Question]
    ...
    \begin{itemize}
        ...
        \item Locked EthereumUnhandled Exception
        \item \textit{tx.origin} Vulnerability
...
\begin{frame}
    ...
    \begin{itemize}
        \item loop bound
        \item call depth
        \item template-based fix patterns
        \item different levels depend on vulnerabilities
    \end{itemize}
